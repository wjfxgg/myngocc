...
model = dict(
    type='STCOccWithoutPredictor_normal_attn_addloss_fix_Tfusion_with_stcocc',
    num_stage=num_stage,
    bev_w=bev_h_,
    bev_h=bev_w_,
    bev_z=bev_z,
        ...
        transformer=dict(
            ...
            encoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            type='OA_TemporalAttentionWithoutPredictor_Norm_with_stcocc',
                            num_points=bev_z,
                            embed_dims=backward_numC_Trans,
                            dropout=0.0,
                            num_levels=1),
                        dict(
                            type='OA_SpatialCrossAttentionWithoutPredictor_adddepth_addnorm_fix_A_with_stcocc',
                            pc_range=point_cloud_range,
                            ...
                            deformable_attention=dict(
                                type='OA_MSDeformableAttention3DWithoutPredictor_adddepth',
                                embed_dims=backward_numC_Trans,
                                num_points=bev_z,
...
load_from="/data/wmw/backup/occshm/code/code/26_1_25/stcocc_r50_704x256_16f_occ3d_36e_without_predictor_normal_attn_addloss_SA_adddepth_fix_normalNet1__Close_ego_2D3D_varqueue_vis_8_16_fix_historyUpdate_from_1_16/STCOcc/work_dirs/stcocc_r50_704x256_16f_occ3d_36e_without_predictor_normal_attn_addloss_SA_adddepth_fix_normalNet1__Close_ego_2D3D_varqueue_vis_8_16_fix_historyUpdate_from_1_16/iter_145328_ema.pth"