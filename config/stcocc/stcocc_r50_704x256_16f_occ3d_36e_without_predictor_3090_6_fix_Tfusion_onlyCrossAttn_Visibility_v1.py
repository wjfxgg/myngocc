                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            num_levels=1),
                        dict(
                            type='OA_SpatialCrossAttentionWithoutPredictor_visibilitiy_v1',
                            pc_range=point_cloud_range,
                            ...
                            deformable_attention=dict(
                                ...
                                visibility_weight_mode='multiply',   # 'multiply' or 'multiply_renorm'
                                visibility_gamma=0.5,                # soften gating when depth is uncertain
                                visibility_min=0.05,                 # keep a small floor to avoid over-suppression
                                # Debug (optional)
                                debug_dump=True,
                                debug_dump_dir='work_dirs/visibility_debug',
                                debug_dump_interval=500,
