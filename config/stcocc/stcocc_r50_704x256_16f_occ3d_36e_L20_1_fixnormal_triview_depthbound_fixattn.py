...
model = dict(
    ...
    srop_g=dict(
        type='SROP_G_fix1',
        in_channels=108,  # BEV特征 + 边缘特征
        hidden_channels=128,
        out_channels=1,
        l2_lambda=0.01
    ),
    # 新添加的模块
    edge_feature_extractor=dict(
        type='EdgeFeatureExtractor_fix_outdim_fixnormal',
        in_channels=3,  # RGB图像
        out_channels=2,
        kernel_size=3,
        stride=1,
    ...
    forward_projection=dict(
        type='BEVDetStereoForwardProjection_fixnormal',
        ...
        img_view_transformer=dict(
            type='LSSVStereoForwardPorjection_fixnormal',
            grid_config=grid_config,
            input_size=data_config['input_size'],
            in_channels=256,
            out_channels=forward_numC_Trans+3,
            sid=False,
            collapse_z=False,
            loss_depth_weight=0.5,
            depthnet_cfg=dict(use_dcn=False,
                              aspp_mid_channels=108,
                              stereo=True,
                              bias=5.),
    ...
    backward_projection=dict(
        type='BEVFormerBackwardProjection_origin_fix1',
        bev_h=bev_h_,
        bev_w=bev_w_,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            num_levels=1),
                        dict(
                            type='OA_SpatialCrossAttention_fix1',
                            pc_range=point_cloud_range,
                            dbound=grid_config['depth'],
                            dropout=0.0,
                            deformable_attention=dict(
                                type='OA_MSDeformableAttention3D_fix1',
                                embed_dims=backward_numC_Trans,
                                num_points=bev_z,
...
load_from="work_dirs/my_fix1_stcocc_r50_704x256_16f_occ3d_36e_4090_8/latest.pth"
find_unused_parameters=False
# work_dir = '/mnt/data/wjf/work_dirs/my_fix1_stcocc_r50_704x256_16f_occ3d_36e_4090_8_fixnormal_triview_depthbound'
