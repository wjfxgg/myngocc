...
model = dict(
    type='STCOccWithoutPredictor_normal_attn_addloss_fix_Tfusion_with_stcocc_TimeV',
    num_stage=num_stage,
    bev_w=bev_h_,
    bev_h=bev_w_,
    bev_z=bev_z,
    ...
    temporal_fusion=dict(
        type='GatedTemporalFusion6_add_sparsefusion_my_add_sim_A_v1_vis',
        history_num=2,
        # top_k=12500,
...
train_pipeline = [
    ...
    dict(type='PointToMultiViewDepth_fix_nomal_triview_fixdirectionByDepthBound_fixattn_fixnormal', downsample=1, grid_config=grid_config),
...
load_from="work_dirs/stcocc_r50_704x256_16f_occ3d_36e_without_predictor_normal_attn_addloss_SA_adddepth_fix_normalNet1__Close_ego_fix_Tfuison_with_stcocc_only_sparseFusionWithmyAdd_sim_A_v1/iter_142984_ema.pth"