...
model = dict(
    type='STCOccWithoutPredictor_normal_attn_addloss_implictNormal',
    num_stage=num_stage,
    bev_w=bev_h_,
    bev_h=bev_w_,
    bev_z=bev_z,
    ...
    forward_projection=dict(
        type='BEVDetStereoForwardProjectionWithNormal_implict',  # 使用扩展的前向投影模块
        ...
        img_view_transformer=dict(
            type='LSSVStereoForwardProjectionWithNormal_implicit',  # 使用扩展的视图变换器
        ...
        transformer=dict(
            ...
            encoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            type='OA_TemporalAttentionWithoutPredictor_Norm_implicit',
                            num_points=bev_z,
                            embed_dims=backward_numC_Trans,
                            dropout=0.0,
                            num_levels=1),
                        dict(
                            type='OA_SpatialCrossAttentionWithoutPredictor_adddepth_addnorm_fix_A_implict',
                            pc_range=point_cloud_range,
