                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            ...
                            num_levels=1),
                        dict(
                            type='OA_SpatialCrossAttentionWithoutPredictor_visibilitiy_v2',
                            pc_range=point_cloud_range,
                            ...
                            deformable_attention=dict(
                                ...
                                # Visibility / occlusion settings
                                dbound=grid_config['depth'],
                                depth_score_mode='termination',      # 'transmittance' | 'prob' | 'termination'
                                visibility_depth_mode='linear',      # 'hard' (old) or 'linear' (recommended)
                                visibility_weight_mode='multiply_renorm',  # keep output scale stable
                                visibility_gamma=1.0,
                                visibility_min=0.0,
                                # Debug (optional)
                                debug_dump=True,
                                debug_dump_dir='work_dirs/visibility_debug_v2',
                                debug_dump_interval=2,
