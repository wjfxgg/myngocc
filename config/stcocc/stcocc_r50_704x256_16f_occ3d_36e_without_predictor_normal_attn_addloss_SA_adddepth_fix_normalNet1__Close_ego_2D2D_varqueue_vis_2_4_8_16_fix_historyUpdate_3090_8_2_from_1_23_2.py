...
model = dict(
    type='STCOccWithoutPredictor_VarQueueDepthVis_fix_normal_attn_addloss_fix_Tfusion',
    num_stage=num_stage,
    bev_w=bev_h_,
    bev_h=bev_w_,
    bev_z=bev_z,
    ...
    forward_projection=dict(
        ...
        img_view_transformer=dict(
            type='LSSVStereoForwardProjectionWithNormal_normalNet1',  # 使用扩展的视图变换器
            grid_config=grid_config,
            input_size=data_config['input_size'],
            in_channels=256,
            out_channels=forward_numC_Trans,
            use_ego_2D_3D_trans_fix=False,
            sid=False,
            collapse_z=False,
    ...
    backward_projection=dict(
        type='BEVFormerBackwardProjection_Norm',
        bev_h=bev_h_,
        bev_w=bev_w_,
        ...
        transformer=dict(
            ...
            encoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            type='OA_TemporalAttentionWithoutPredictor_Norm',
                            num_points=bev_z,
                            embed_dims=backward_numC_Trans,
                            dropout=0.0,
                            num_levels=1),
                        dict(
                            type='OA_SpatialCrossAttentionWithoutPredictor_adddepth_addnorm_fix_A_2D2D',
                            pc_range=point_cloud_range,
    ...
    # ),
    temporal_fusion=dict(
        type='ObservableQueueFusionDepthVis_fix_historyUpdate_fix',
        # single_bev_num_channels=backward_numC_Trans,
        num_T=16,
...
revise_keys = None
# load_from="work_dirs/stcocc_r50_704x256_16f_occ3d_36e_without_predictor_normal_attn_addloss_SA_adddepth_fix_normalNet1__Close_ego_2D2D_varqueue_vis_8_16_fix_historyUpdate_3090_8_2/iter_20.pth"
# load_from="pretrained/forward_projection-r50-4d-stereo-pretrained.pth"
load_from="work_dirs/stcocc_r50_704x256_16f_occ3d_36e_without_predictor_normal_attn_addloss_SA_adddepth_fix_normalNet1__Close_ego_2D2D_varqueue_vis_8_16_fix_historyUpdate_3090_8_2/iter_126576.pth"
