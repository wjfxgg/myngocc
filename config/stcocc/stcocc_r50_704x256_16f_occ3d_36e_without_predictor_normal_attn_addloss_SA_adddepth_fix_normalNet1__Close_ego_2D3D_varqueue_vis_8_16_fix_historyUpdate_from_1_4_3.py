            ...
            encoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        # )
                        dict(
                            type='OA_SpatialCrossAttentionWithoutPredictor_adddepth_addnorm_fix_A',
                            pc_range=point_cloud_range,
                            dbound=grid_config['depth'],
                            dropout=0.0,
                            num_points=bev_z,
...
load_from="work_dirs/stcocc_r50_704x256_16f_occ3d_36e_without_predictor_normal_attn_addloss_SA_adddepth_fix_normalNet1__Close_ego_fix_Tfuison/iter_84384.pth"
