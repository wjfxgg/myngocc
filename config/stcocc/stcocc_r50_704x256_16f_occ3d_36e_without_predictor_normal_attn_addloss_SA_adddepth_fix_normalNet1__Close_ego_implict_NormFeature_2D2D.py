...
model = dict(
    type='STCOccWithoutPredictor_normal_attn_addloss_2D2D',
    num_stage=num_stage,
    bev_w=bev_h_,
    bev_h=bev_w_,
    bev_z=bev_z,
    ...
    forward_projection=dict(
        ...
        img_bev_encoder_backbone=dict(
            type='CustomResNet3D',
            numC_input=(forward_numC_Trans+3) * (len(range(*multi_adj_frame_id_cfg))+1),
            num_layer=[1, 2, 4],
            with_cp=False,
        ...
        transformer=dict(
            ...
            encoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            type='OA_TemporalAttentionWithoutPredictor_Norm_2D2D',
                            num_points=bev_z,
                            embed_dims=backward_numC_Trans,
                            dropout=0.0,
                            num_levels=1),
