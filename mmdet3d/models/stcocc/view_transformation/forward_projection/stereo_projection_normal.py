...
class LSSForwardProjectionWithNormal(LSSForwardProjection):
    """
...
@NECKS.register_module()
class LSSVStereoForwardProjectionWithNormal(LSSVStereoForwardPorjection):
    """
...
@NECKS.register_module()
class LSSVStereoForwardProjectionWithNormal_normalNet1(LSSVStereoForwardPorjection):
    """
    立体视觉版本的LSSForwardProjectionWithNormal
    继承了LSSVStereoForwardPorjection的所有功能，并添加了normal预测支持
    """
...
@NECKS.register_module()
class LSSVStereoForwardProjectionWithNormal_normalNet2(LSSVStereoForwardPorjection):
    """
    立体视觉版本的LSSForwardProjectionWithNormal
    继承了LSSVStereoForwardPorjection的所有功能，并添加了normal预测支持
    """
