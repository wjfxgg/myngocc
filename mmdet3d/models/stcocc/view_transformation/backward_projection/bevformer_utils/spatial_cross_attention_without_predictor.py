...
class OA_SpatialCrossAttentionWithoutPredictor(BaseModule):
    ...
    def __init__(self,
        ...
        super(OA_SpatialCrossAttentionWithoutPredictor, self).__init__(init_cfg)
...
@ATTENTION.register_module()
class OA_MSDeformableAttention3DWithoutPredictor(BaseModule):
