...
class OA_SpatialCrossAttentionWithoutPredictor_adddepth_addnorm_fix_A(BaseModule):
    ...
    def __init__(self,
        ...
        super(OA_SpatialCrossAttentionWithoutPredictor_adddepth_addnorm_fix_A, self).__init__(init_cfg)
...
@ATTENTION.register_module()
class OA_MSDeformableAttention3DWithoutPredictor_adddepth_addnorm_fix_A(BaseModule):
