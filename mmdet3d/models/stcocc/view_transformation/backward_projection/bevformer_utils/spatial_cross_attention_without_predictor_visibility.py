...
class OA_SpatialCrossAttentionWithoutPredictor_visibilitiy(BaseModule):
    ...
    def __init__(self,
                 ...
                 deformable_attention=dict(
                     type='OA_MSDeformableAttention3DWithoutPredictor_visibility',
                     embed_dims=256,
                     num_levels=4),
                 layer_scale=None,
                 dbound=None,
        ...
        super(OA_SpatialCrossAttentionWithoutPredictor_visibilitiy, self).__init__(init_cfg)
...
@ATTENTION.register_module()
class OA_MSDeformableAttention3DWithoutPredictor_visibility(BaseModule):
    ...
    def forward(self,
        ...
        bev_query_depth_rebatch = (reference_points_depth- self.dbound[0])/ self.dbound[2]
        ...
        attention_weights = attention_weights * depth_output[:,:, None,None,:]
