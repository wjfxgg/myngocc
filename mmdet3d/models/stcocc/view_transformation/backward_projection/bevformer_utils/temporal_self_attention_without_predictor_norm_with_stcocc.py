...
class OA_TemporalAttentionWithoutPredictor_Norm_with_stcocc(BaseModule):
    ...
    def forward(self,
                ...
                ego_dir_vector_3d_xyz_i: Optional[torch.Tensor] = None, #bs,3(x,y,z),z,h,w
                **kwargs) -> torch.Tensor:
        ...
        B = ego_dir_vector_3d_xyz_i.flatten(3).permute(0,3,2,1) #bs,num_query,num_points,3(x,y,z)
        ...
        attention_weights = attention_weights * sin_squard * nonempty_attention_weights[:, :, None, None, None, :]
