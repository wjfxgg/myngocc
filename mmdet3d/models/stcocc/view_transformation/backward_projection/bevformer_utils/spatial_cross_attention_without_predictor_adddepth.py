...
class OA_SpatialCrossAttentionWithoutPredictor_adddepth(BaseModule):
    ...
    def __init__(self,
        ...
        super(OA_SpatialCrossAttentionWithoutPredictor_adddepth, self).__init__(init_cfg)
...
@ATTENTION.register_module()
class OA_MSDeformableAttention3DWithoutPredictor_adddepth(BaseModule):
