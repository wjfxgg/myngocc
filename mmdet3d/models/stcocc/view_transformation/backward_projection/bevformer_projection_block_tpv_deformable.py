...
from mmdet3d.models.stcocc.modules.block_tpv_deformable import MultiScaleBlockTPVDeformable


@HEADS.register_module()
class BEVFormerBackwardProjectionBlockTPVDeformable(BEVFormerBackwardProjection_Norm):
    """BEVFormer backward projection with deformable block TPV to reduce memory."""
    ...
    def __init__(self, block_tpv_cfg=None, **kwargs):
        ...
        if block_tpv_cfg is None:
            ...
            block_tpv_cfg.setdefault('num_points', 4)
            ...
            block_tpv_cfg.setdefault('im2col_step', 64)
        self.block_tpv = MultiScaleBlockTPVDeformable(**block_tpv_cfg)
