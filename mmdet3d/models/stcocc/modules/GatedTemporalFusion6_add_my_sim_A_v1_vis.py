...
class GatedTemporalFusion6_add_sparsefusion_my_add_sim_A_v1_vis(BaseModule):
    def __init__(
        self,
        history_num=4,
        ...
        **kwargs
        ...
        super(GatedTemporalFusion6_add_sparsefusion_my_add_sim_A_v1_vis, self).__init__()
