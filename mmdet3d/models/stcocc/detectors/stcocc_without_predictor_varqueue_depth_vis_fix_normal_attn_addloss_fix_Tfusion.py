...
class STCOccWithoutPredictor_VarQueueDepthVis_fix_normal_attn_addloss_fix_Tfusion(CenterPoint):
    ...
    def _build_temporal_fusion_old(self, temporal_fusion_config, num_stage):
